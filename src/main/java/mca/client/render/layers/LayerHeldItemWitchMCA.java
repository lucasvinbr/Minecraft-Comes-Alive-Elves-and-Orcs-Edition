package mca.client.render.layers;
...
public class LayerHeldItemWitchMCA implements LayerRenderer<EntityWitchMCA> {

	private final RenderWitchMCA witchRenderer;

	public LayerHeldItemWitchMCA(RenderWitchMCA witchRendererIn) {
        this.witchRenderer = witchRendererIn;
    }

	@Override
	public void doRenderLayer(EntityWitchMCA entitylivingbaseIn, float limbSwing, float limbSwingAmount,
