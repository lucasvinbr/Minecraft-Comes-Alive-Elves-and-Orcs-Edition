...
public enum EnumProfession {
	...
	Farmer(0, EnumProfessionSkinGroup.Farmer, 0),
	Fisherman(1, EnumProfessionSkinGroup.Farmer, 0),
	Shepherd(2, EnumProfessionSkinGroup.Farmer, 0),
	Fletcher(3, EnumProfessionSkinGroup.Farmer, 0),
	Librarian(4, EnumProfessionSkinGroup.Librarian, 1),
	Cleric(5, EnumProfessionSkinGroup.Priest, 2),
	Armorer(6, EnumProfessionSkinGroup.Smith, 3),
	WeaponSmith(7, EnumProfessionSkinGroup.Smith, 3),
	...
	public static EnumProfession getNewProfessionFromVanilla(int id) {
		switch (id) {
			case 0:
				return getRandomByGroup(EnumProfessionSkinGroup.Farmer, EnumProfessionSkinGroup.Miner);
			case 1:
				return getRandomByGroup(EnumProfessionSkinGroup.Librarian);
			case 2:
				return getRandomByGroup(EnumProfessionSkinGroup.Priest);
			case 3:
...
//			case Orc:
//				return "profession.orc";
//			case Elf:
//				return "profession.elf";
		}
