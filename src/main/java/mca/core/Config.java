...
public final class Config implements Serializable {
	...
	private int orcMatingSeasonDuration;
	...
	private void addConfigValues() {
		...
		allowVillagerRevival =
				config.get("Server",
						...
						.getBoolean();
		setOrcMatingSeasonDuration(config
				.get("orc_mating_season_time", "How long the orc mating season lasts in minutes.", 5).getInt());
	...
	public int getOrcMatingSeasonDuration() {
		return orcMatingSeasonDuration;
	}

	public void setOrcMatingSeasonDuration(int orcMatingSeasonDuration) {
		this.orcMatingSeasonDuration = orcMatingSeasonDuration;
	}
