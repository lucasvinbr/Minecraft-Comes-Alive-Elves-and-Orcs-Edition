...
import mca.client.render.RenderWitchFactory;
...
public class ClientProxy extends ServerProxy {
	...
	public void registerEntityRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityChoreFishHook.class,
		...
		/*
		 * RenderingRegistry.registerEntityRenderingHandler(EntityHorse.class, new
		 * RenderHorse(Minecraft.getMinecraft().getRenderManager(), new
		 * ModelHorseExtension(), 0.5F));
		 */
