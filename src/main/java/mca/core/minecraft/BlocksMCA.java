...
public final class BlocksMCA {
	...
	// public static Block titanspawner;
	// public static Block bigTreeSapling;
	...
	public static void register(RegistryEvent.Register<Block> event) {
		...
		Block[] blocks = { rose_gold_block, rose_gold_ore, tombstone, villager_spawner,
				memorial/*
						 * , titanspawner, bigTreeSapling
						 */
		};
	...
	public static void registerItemBlocks(RegistryEvent.Register<Item> event) {
		...
		ItemBlock[] items = { new ItemBlock(rose_gold_block), new ItemBlock(rose_gold_ore),
