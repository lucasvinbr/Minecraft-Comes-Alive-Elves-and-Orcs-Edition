...
public final class ItemsMCA {
	...
	public static final Item WEDDING_RING_RG = new ItemTooltipAppender()
			.setTooltip("Gift to a villager with 5 gold hearts to marry them.").setMaxStackSize(1);
	public static final Item ENGAGEMENT_RING = new ItemTooltipAppender()
			.setTooltip("Gift to a villager with 5 gold hearts to become engaged.").setMaxStackSize(1);
	public static final Item ENGAGEMENT_RING_RG = new ItemTooltipAppender()
			.setTooltip("Gift to a villager with 5 gold hearts to become engaged.").setMaxStackSize(1);
	public static final Item MATCHMAKERS_RING = new ItemTooltipAppender()
			.setTooltip("Gift two to villagers standing close to each other to arrange a marriage between them.")
			.setMaxStackSize(2);
	public static final Item DIVORCE_PAPERS = new ItemTooltipAppender()
	...
	public static final Item ROSE_GOLD_DUST = new ItemTooltipAppender()
			.setTooltip("Dust from a crushed rose gold ingot.");
	public static final Item GOLD_DUST = new Item();
	public static final ItemNewOutfit NEW_OUTFIT = new ItemNewOutfit();
	public static final Item NEEDLE_AND_STRING = new ItemTooltipAppender()
			.setTooltip("Use with some wool to create cloth.").setMaxDamage(16).setMaxStackSize(1);
	public static final Item CLOTH = new ItemTooltipAppender()
			.setTooltip("This can be used to craft new clothes for your villagers.");
	...
	public static void setBookNBT(ItemStack stack) {
		...
		if (book == BOOK_DEATH) {
			...
			pages.appendTag(new NBTTagString(Format.BOLD + "Memorials\n\n" + Format.RESET
					+ "When a family member dies, they will drop a chest - and inside will be an " + Format.BOLD
					+ "item" + Format.RESET + " that was important to them.\n\n"
			...
			pages.appendTag(new NBTTagString(
					Format.BOLD + "Fighting Grim pt. 3\n\n" + Format.RESET + "When Grim is at " + Format.BOLD
							+ "half health" + Format.RESET + " he will teleport into the air and begin healing.\n\n"
